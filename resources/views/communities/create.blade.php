    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto bg-gray-50 border rounded-md">
            <div class="mx-auto bg-gray-100">
                <h3 class="text-2xl p-4">Add New Community</h3>
            </div>
                    ...
                    <div class="flex justify-between mb-4 w-full">
                        ...
                        <div class="flex flex-col justify-between self-stretch w-3/4">
                            @foreach($topics as $topic)
                                <div><x-jet-checkbox name="topics[]" id="topics[]"
                                                :value="$topic->id"></x-jet-checkbox>{{$topic->name}}</div>
                            @endforeach
                        </div>
                    </div>

                    <x-buy-button class="mt-4 mb-4 self-center">Create</x-buy-button>
                </form>
            </div>
        </div>
    </div>
